...
const Hero = () => {
  return (
    <div id="hero" className="container d-flex flex-column justify-content-center">
        ...
        <div className="mt-5"><a href="mailto:eleanorjfoote@gmail.com" className="cta fs-4 py-2 px-3 me-3 text-light shadow">Want to chat?</a><Link to="about-me" className="my-secondary-btn fs-4 py-2 px-3 shadow">Learn more</Link></div>
    </div>
  )
}
